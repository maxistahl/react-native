...
import { AppRegistry, Dimensions, ScrollView, View, Text, StyleSheet, Platform } from "react-native";
      ...
      <ScrollView >
        <View style={styles.container}>
          ...
          {this.state.members.map( (member, key) => {
              return <MemberAvatar key={key} name={member.name} image={`http://tarmac.io/assets/members/${member.pic}.png`}/>
            })
          }
